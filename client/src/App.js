...
import { baseUrlDev, baseUrlProd } from './utils/apiUrl';
    ...
    const toggleCompleted = async (id) => {
        try {
            ...
            setTodos(prevTodos => 
                prevTodos.map(todo => 
                    todo.id === id 
                        ? { ...todo, is_completed: res.data.updatedTodo.is_completed }
                        : todo
                )
            );
        } catch (err) {
                        ...
                        {todoEditing === todo.id 
                            ...
                            <div className="input-show">
                                ...
                                <p className="input-show-time">
                                    <span className="span-time">Created at: {new Date(todo.created_at).toLocaleString()}</span>
                                </p>
                                <p className="input-show-time">
                                    <span className="span-time">Updated at: {new Date(todo.updated_at).toLocaleString()}</span>
                                </p>
                            </div>
                        }
                        {/* 'todo' is changable */}
